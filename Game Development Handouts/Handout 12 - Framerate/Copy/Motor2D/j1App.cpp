...
j1App::j1App(int argc, char* args[]) : argc(argc), args(args)
{
	...
	LOG("Constructor took %f ms", perf_timer->ReadMs());	//Check how many milliseconds have passed since the timer was initialized. In this case it counts how much time was needed to go through the constructor.
}
...
bool j1App::Awake()
{
	...
	LOG("Awake took %f ms", perf_timer->ReadMs());
	return ret;
}
...
bool j1App::Start()
{
	...
	LOG("Start took %f ms", perf_timer->ReadMs());
	return ret;
}
...
bool j1App::CleanUp()
{
	...
	LOG("CleanUp took %f ms", perf_timer->ReadMs());
	return ret;
}
