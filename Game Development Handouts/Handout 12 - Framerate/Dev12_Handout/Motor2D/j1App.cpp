...
{	
	...
	LOG("j1App::j1App constructor took %d seconds", perftimer->ReadMs());
}
...
bool j1App::Start()
{
	timer->Start(); // Amount of time since game start. Average fps through whole life is combining frames+timer->start / 
