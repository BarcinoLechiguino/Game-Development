...
UI_Image::UI_Image(UI_Element element, int x, int y, SDL_Rect rect, UI* parent) : UI(UI_Element::IMAGE, x, y, rect, parent) //When a UI_Image's constructor is called, a UI element is initialized as a IMAGE element.
{
