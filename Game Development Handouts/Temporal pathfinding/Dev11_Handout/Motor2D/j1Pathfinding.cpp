...
int j1PathFinding::CreatePath(const iPoint& origin, const iPoint& destination)
{
	...
	PathNode origin_node (0, 0, origin, NULL);		//Creates a node at the origin point of the path. Parent is NULL because its the origin. 
	...
	while (open.list.count() != 0)
	{
		...
		p2List_item<PathNode>* adjacent_iterator = adjacent.list.start;
