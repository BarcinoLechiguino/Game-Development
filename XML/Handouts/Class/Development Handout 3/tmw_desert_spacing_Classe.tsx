...
<tileset name="tmw_desert_spacing" tilewidth="32" tileheight="32" spacing="1" margin="1" tilecount="48" columns="8">
 <image source="Dev_class4_handout/Game/maps/tmw_desert_spacing.png" width="265" height="199"/>
 <terraintypes>
  <terrain name="Sand" tile="29"/>
  <terrain name="Stone Brick" tile="9"/>
  <terrain name="Cobblestone" tile="33"/>
  <terrain name="Dry Earth" tile="14"/>
  <terrain name="Cactus" tile="30"/>
  <terrain name="Rocks" tile="31"/>
  <terrain name="Bush 1" tile="37"/>
  <terrain name="Bush 2" tile="38"/>
  <terrain name="Bush 3" tile="39"/>
  <terrain name="Sign" tile="45"/>
  <terrain name="Thicket 1" tile="46"/>
  <terrain name="Thicket 2" tile="47"/>
 </terraintypes>
